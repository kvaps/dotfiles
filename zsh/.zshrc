...
POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION+='$P9K_KUBECONTEXT_NAME %006F${${:-$P9K_KUBECONTEXT_NAMESPACE}:#default}'
...
POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='$P9K_KUBECONTEXT_NAME %006F${${:-$P9K_KUBECONTEXT_NAMESPACE}:#default}'
